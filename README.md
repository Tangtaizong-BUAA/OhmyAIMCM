# Lab-ultra-unified：全国大学生数学建模竞赛论文 Skill

Lab-ultra-unified 是面向全国大学生数学建模竞赛（国赛）论文建模、撰写与排版的 Agent Skill。项目将期刊论文的版式分析与获奖国赛论文的论证经验转化为结构化资源，并与读题、建模、计算、科学绘图、写作和审查模块结合。项目标识为 `lab-ultra-unified`，安装后的调用入口为 `$lab-ultra`。
