...
Use the [shared material library](../../lab-ultra-scientific-figure-maker/references/material-library.md) to obtain the actual recipe source and style. The following are selection hints, not automatic analysis steps.
