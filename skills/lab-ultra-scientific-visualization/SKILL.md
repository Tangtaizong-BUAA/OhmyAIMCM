...
In this project, use the shared [material library](../lab-ultra-scientific-figure-maker/references/material-library.md) for upstream styles and recipe lookup. Resolve the sibling lab-ultra-scientific-figure-maker/scripts directory onto sys.path, then use Matplotlib's object-oriented API and one temporary style context:
