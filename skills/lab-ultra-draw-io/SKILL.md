...
- Codex on Windows: junction `C:\Users\YOUR_NAME\.codex\skills\lab-ultra-draw-io -> D:\Prj\draw-io-skill`
...
2. For CUMCM or scientific-paper figures, read `../lab-ultra-scientific-figure-maker/references/diagram-design.md` and use its paper-specific semantic and visual defaults. For other diagrams without a user-specified style, start from `references/aesthetic-templates.md` and its polished technical light template.
...
For new diagrams, choose a visual treatment before writing the XML. Scientific-paper diagrams follow `../lab-ultra-scientific-figure-maker/references/diagram-design.md`: white or paper-transparent backgrounds, neutral lines, and ordinary rectangles or domain-native symbols when appropriate. Do not add rounded cards, accent colors, title/body chips, or dashboard panels merely to appear polished. User-specified and scientifically meaningful encodings remain allowed.
