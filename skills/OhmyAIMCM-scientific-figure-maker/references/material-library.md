...
Put this Skill's scripts and the sibling OhmyAIMCM-scientific-visualization scripts on sys.path in the figure's source. Use one style context for the whole figure:
