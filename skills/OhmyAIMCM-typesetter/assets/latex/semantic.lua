...
local environment_for_class = {
  assumption = "OhmyAIMCMassumption",
  definition = "OhmyAIMCMdefinition",
  theorem = "OhmyAIMCMtheorem",
  lemma = "OhmyAIMCMlemma",
  proposition = "OhmyAIMCMproposition",
  proof = "OhmyAIMCMproof",
  algorithm = "OhmyAIMCMalgorithm",
  result = "OhmyAIMCMresult",
  note = "OhmyAIMCMnote",
  model = "cummodel"
}
