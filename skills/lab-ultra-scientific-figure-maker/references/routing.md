...
|---|---|---|
| Statistical or experimental data | lab-ultra-scientific-figure-maker, with lab-ultra-scientific-visualization for export/audit | Bundled publication styles; catalog specialized recipes |
| Data profiling and chart selection | lab-ultra-scipilot-figure-skill | Existing profile_data.py; shared integrity/selection rules |
| ML method or result extraction | lab-ultra-academic-plotting | Convert paper context into FigureRequest; return to the selected renderer |
| Workflow / dependency graph | lab-ultra-figure-spec; lab-ultra-draw-io when native .drawio is required | Apply diagram-design.md; meaningful dependencies, not paper section order |
...
| Search visual references | lab-ultra-agent-figure-gallery | Stable reference IDs; catalog design_examples |
| Iterative code and visual feedback | lab-ultra-figure-generation | Shared recipes/style/export; preserve input data on repair |
...
| PaperBanana experiment explicitly selected | lab-ultra-generate-plot / lab-ultra-generate-diagram / lab-ultra-evaluate-diagram | Check actual MCP or CLI availability; wrappers alone are not a runtime |
