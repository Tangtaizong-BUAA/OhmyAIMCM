---
name: OhmyAIMCM-references
description: OhmyAIMCM CUMCM paper suite. Query a prescreened CUMCM reference collection for a specific modeling, validation, implementation, writing or figure knowledge gap. Return provenance and bounded source passages; do not select algorithms from task labels or search historical contest answers by default.
---
...
use [OhmyAIMCM-sciverse](../OhmyAIMCM-sciverse/SKILL.md) when the existing SciVerse connection
