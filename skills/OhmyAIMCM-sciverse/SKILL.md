---
name: OhmyAIMCM-sciverse
description: OhmyAIMCM CUMCM paper suite. Retrieve and inspect academic evidence through an available SciVerse connection for CUMCM modeling, validation, related work or scientific-writing study. Use for a concrete literature need, not as a mandatory model-selection step.
---
...
backend. The local `OhmyAIMCM-references` library and live literature retrieval are
...
Keep the necessary [writing guidance](../OhmyAIMCM-writing/SKILL.md) in force. A successful
...
[library's admission procedure](../OhmyAIMCM-references/SKILL.md) for explicit collection work.
