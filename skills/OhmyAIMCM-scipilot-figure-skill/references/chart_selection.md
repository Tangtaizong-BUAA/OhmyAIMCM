...
Read [shared integrity gates](../../OhmyAIMCM-scientific-figure-maker/references/selection-and-integrity.md) for admissibility and [plot_recipes.md](plot_recipes.md) for code entrypoints.
