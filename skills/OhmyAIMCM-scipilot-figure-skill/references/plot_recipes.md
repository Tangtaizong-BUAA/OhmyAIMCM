...
Use [material-library.md](../../OhmyAIMCM-scientific-figure-maker/references/material-library.md) for the executable starter schema, library lookup and style context. All routes use actual supplied data and a single export owner.

| Figure | Source |
|---|---|
| Line / scatter / bar / simple matrix | OhmyAIMCM-scientific-figure-maker/scripts/render_recipe.py |
...
Use OhmyAIMCM-figure-generation when code/render/visual repair is needed. Repairs preserve the source data and chosen statistical definitions.
