---
name: lab-ultra-review
description: Experimental CUMCM lab suite. Audit CUMCM mathematical arguments, execution evidence, paper consistency and delivery readiness. Use for read-only review or pre-release checks; distinguish file/format checks from numerical, scientific, visual and team review.
---
...
For paper review, select [paper conventions](../lab-ultra-writing/references/paper-conventions.md)
when notation/references are in scope. For comprehensive content-expression or pre-release review, use
[expression review](../lab-ultra-writing/references/expression-review.md): inspect meaning,
...
For a complete supported Markdown candidate, run `../lab-ultra-writing/scripts/paper_preflight.py check`
...
[native handoff contract](../lab-ultra/references/handoffs.md). Identify the exact candidate
...
[run_record.py](../lab-ultra-compute/scripts/run_record.py). Then inspect mathematical
