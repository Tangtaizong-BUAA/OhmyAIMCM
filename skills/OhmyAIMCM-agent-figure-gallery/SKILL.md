---
name: OhmyAIMCM-agent-figure-gallery
description: OhmyAIMCM CUMCM paper suite. Query visual scientific figure references, show candidates for human preference selection, export selected reference bundles, and guide plotting agents from human-selected visual examples to code action.
---
...
# OhmyAIMCM-agent-figure-gallery
