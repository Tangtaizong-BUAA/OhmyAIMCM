---
name: lab-ultra-evaluate-diagram
description: Experimental CUMCM lab suite. Evaluate a generated diagram against a human reference through PaperBanana when its MCP or CLI runtime is explicitly available. Use scores as review evidence only, never as scientific correctness or an automatic acceptance gate.
allowed-tools:
...
```
/lab-ultra-evaluate-diagram output.png reference.png
```
