---
name: lab-ultra-agent-figure-gallery
description: Experimental CUMCM lab suite. Query visual scientific figure references, show candidates for human preference selection, export selected reference bundles, and guide plotting agents from human-selected visual examples to code action.
---
