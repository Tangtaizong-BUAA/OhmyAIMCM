...
Use OhmyAIMCM-figure-spec for structured SVG, or OhmyAIMCM-draw-io when native editing is needed. Use a left-to-right pipeline for ordered stages, bands for layers, a tree for hierarchy, and a separate return edge for feedback when these relationships match the source.
...
Read [shared routes](../../OhmyAIMCM-scientific-figure-maker/references/routing.md) and [material library](../../OhmyAIMCM-scientific-figure-maker/references/material-library.md) for the current entrypoints.
