"""
lab-ultra-scipilot-figure-skill :: export_figure.py
=========================================
...
def export_figure(
    ...
    for fmt in formats:
        if fmt in {"jpg", "jpeg"}:
            print(f"[lab-ultra-scipilot-figure-skill] WARNING: skipping {fmt} — "
        ...
        saved.append(path)
        print(f"[lab-ultra-scipilot-figure-skill] wrote {path}")
...
def _grayscale_from(fig, basename: str, dpi: int) -> str | None:
    ...
    try:
        ...
        print("[lab-ultra-scipilot-figure-skill] Pillow not available; "
    ...
    print(f"[lab-ultra-scipilot-figure-skill] wrote {gray_path} (grayscale preview)")
    return gray_path
...
def _cli() -> int:
    p = argparse.ArgumentParser(description="lab-ultra-scipilot-figure-skill figure exporter")
