"""
lab-ultra-scipilot-figure-skill :: profile_data.py
========================================
Exploratory data analysis for figure planning.

本脚本是 lab-ultra-scipilot-figure-skill"思考-绘制"工作流的第 1 步。
...
def _cli() -> int:
    p = argparse.ArgumentParser(description="lab-ultra-scipilot-figure-skill data profiler")
