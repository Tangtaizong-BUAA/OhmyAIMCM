"""
lab-ultra-scipilot-figure-skill :: check_figure.py
========================================
...
def _cli() -> int:
    p = argparse.ArgumentParser(description="lab-ultra-scipilot-figure-skill compliance checker")
    ...
    if args.strict and any_fail:
        print("[lab-ultra-scipilot-figure-skill] strict mode: at least one FAIL — exit 2")
        return 2
    return 0
