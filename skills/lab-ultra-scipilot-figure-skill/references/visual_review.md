...
Use [the shared material library](../../lab-ultra-scientific-figure-maker/references/material-library.md) and lab-ultra-scientific-visualization's figure_export for final output. Run post-export metadata checks and inspect the delivered file, since a preview alone can miss export-specific differences.
