---
name: lab-ultra-compute
description: Experimental CUMCM lab suite. Implement, execute and check CUMCM computations, including exploratory probes before a model is finalized. Use for data processing, numerical solving, simulations, validation and reproduction within the user's authorized scope and budget.
---
...
[lab-ultra-writing](../lab-ultra-writing/SKILL.md) and the figure worker.
