---
name: OhmyAIMCM-modeling
description: OhmyAIMCM CUMCM paper suite. Formulate and revise mathematical models for CUMCM tasks from actual problem conditions and evidence. Use for derivation, assumptions, route selection, interpretation of pilot results and validation design without a prescribed method catalogue.
---
...
[OhmyAIMCM-references](../OhmyAIMCM-references/SKILL.md) or another authoritative source. Treat its
...
Use [OhmyAIMCM-compute](../OhmyAIMCM-compute/SKILL.md) for authorized pilot computations
